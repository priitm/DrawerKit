...
#ifndef DRAWERKIT_SWIFT_H
#define DRAWERKIT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="DrawerKit",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif


/// Instances of this class are returned by objects conforming to
/// the <code>DrawerCoordinating</code> protocol.
SWIFT_CLASS("_TtC9DrawerKit23DrawerDisplayController")
@interface DrawerDisplayController : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end


@interface DrawerDisplayController (SWIFT_EXTENSION(DrawerKit)) <UIAdaptivePresentationControllerDelegate>
@end
...
@interface DrawerDisplayController (SWIFT_EXTENSION(DrawerKit)) <UIViewControllerTransitioningDelegate>
